...
$points = [
    ...
    'hakone' => [35.233383, 139.103916] // 箱根湯本駅の緯度経度
];

//東京駅を表す赤いピン画像を作る
$pin1 = new GenericPin(30, 'red');
$pin1->setMessage('ここば東京駅');

//箱根湯本駅を表す緑のピン画像を作る
$pin2 = new GenericPin(30, 'green');
$pin2->setMessage('ここは箱根湯本駅');

//衛星画像を表すMapImageインスタンスを作る。これはMapクラスのコンストラクタを渡す。
...
//緑のピンを箱根湯本駅に置く
$map->addPin($pin1, $points['hakone'][0], $points['hakone'][1]);
//２つのピンを線で結ぶ
$map->drawLine('black', $points['tokyo'][0],  $points['tokyo'][1], $points['hakone'][0], $points['hakone'][1]);
//完成した地図を表示する
$map->draw();